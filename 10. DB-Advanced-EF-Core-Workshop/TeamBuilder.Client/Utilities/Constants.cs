namespace TeamBuilder.Client.Utilities
{
    public static class Constants
    {
        ...
        public static class ErrorMessages
        {
            ...
            public const string EventAlreadyExist = "Event with the same name already exist!";
            ...
            public const string InvalidNameLenght = "Name should be no longer than 25 symbols";
            ...
            public const string InvalidEndDate = "Start date should be before end date.";
            ...
            public const string InvalidTeamName = "Team name should be no longer than 25 symbols";

            public const string InvalidDescription = "Description should be no longer than {0} symbols";
        }
    }
